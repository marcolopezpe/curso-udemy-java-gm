...
public class ManejoVariableTest {
    ...
    public static void main(String[] args) {
        ...
        //Variable char, declaracion e inicializacion en una solia linea
        //La primera declaracion es en UNICODE
        //http://www.icurso.net/referencias/TablaUnicode.html
        char ch1 = 65, ch2 = 'A';
        ...
        System.out.println("Valor int decial: " + decimal);
